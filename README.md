...
A mobile-first, installable web app for a high-protein, **assembly-only**
vegetarian meal plan. No egg, no cheese, no batch cooking — the most you'll
ever do is toast bread or sear paneer for five minutes.
...
- **The week** — Mon–Sun chart (breakfast/lunch/dinner) with office / WFH / off
  tags, per-meal time, protein, and a per-day protein total. Opens on today.
